...
TOOLCHAIN_DIR_MAIN:=C:\Program Files\TASKING\TriCore v4.3r1\ctc

#user defined include paths start with -I
USER_C_INCLUDES:=-I$(PROJ_DIR)/2_Out/Tasking/0_Src/4_McHal/Mcs
USER_ASM_INCLUDES:=

# Compiler options 
CC_OPTIONS_MAIN := --core=tc1.6.x -D_CTRI --no-double --iso=99	\
			--language=-gcc,-strings --switch=auto --align=4 --default-near-size=0 		\
			--default-a0-size=8 --default-a1-size=8 -ONRpfceogvIlywakmsU 			\
...
LIBS = $(LIB_DIR)/librt.a $(LIB_DIR)/libcs_fpu.a $(LIB_DIR)/libfp_fpu.a "$(TOOLCHAIN_DIR_MAIN)/../cpcp/lib/pcp1/libfp.a"
