...
TOOLCHAIN_DIR_MAIN:=C:\Tools\Compilers\Windriver\diab\5.9.3.0\WIN32

#user defined include paths start with -I
USER_C_INCLUDES:=-I$(PROJ_DIR)/2_Out/Dcc/0_Src/4_McHal/Mcs
USER_ASM_INCLUDES:=

# Compiler options

CC_OPTIONS_MAIN = -DWINDRIVER -tTC16NF:windiss -O -Xsection-split=3 \
		-Xkeep-assembly-file=2 -Xsmall-data=0 -Xsmall-const=8 -g3 \
           -XO -Xinline=0 -Xunroll-size=200 -ei5388,2273,5387
